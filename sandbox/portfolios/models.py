...
class  Investment(models.Model):
	...
	asset_class = models.CharField(max_length=25, blank=True, null=True, choices=ASSET_CLASSES)
	investments = models.ManyToManyField('self', blank=True, symmetrical=False, through="Allocation")
